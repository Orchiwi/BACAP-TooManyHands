...
scoreboard players operation #sc_d bacaptmh_tmp = @s bacaptmh_trid
scoreboard players operation #sc_d bacaptmh_tmp -= @s bacaptmh_tridm
scoreboard players operation @s bacaptmh_tridm = @s bacaptmh_trid
