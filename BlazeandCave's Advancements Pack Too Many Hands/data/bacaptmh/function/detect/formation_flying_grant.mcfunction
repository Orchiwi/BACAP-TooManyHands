...
execute if score #ffn bacaptmh_tmp4 matches 3.. run advancement grant @a[tag=bacaptmh_fly,scores={bacaptmh_form=4..},distance=..10] only bacaptmh:end/formation_flying
