...
execute if score #ss bacaptmh_tmp4 matches 3.. run advancement grant @a[tag=bacaptmh_dark,scores={bacaptmh_dd=24..},distance=..48] only bacaptmh:biomes/sculk_silence
