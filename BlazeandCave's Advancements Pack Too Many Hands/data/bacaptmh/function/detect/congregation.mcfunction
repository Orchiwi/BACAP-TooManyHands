...
execute if score #cgout bacaptmh_tmp4 matches 0 if score #cgtot bacaptmh_tmp4 matches 4.. run advancement grant @a[gamemode=!spectator] only bacaptmh:end/congregation
