...
scoreboard players operation #d bacaptmh_repn = @s bacaptmh_rep
scoreboard players operation #d bacaptmh_repn -= @s bacaptmh_repm
scoreboard players operation @s bacaptmh_repm = @s bacaptmh_rep
