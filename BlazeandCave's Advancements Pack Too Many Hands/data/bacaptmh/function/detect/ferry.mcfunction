...
execute if score #b7mode bacaptmh_tmp matches 1 run scoreboard players set #b7d bacaptmh_tmp 0
execute if score #b7mode bacaptmh_tmp matches 1 if score @s bacaptmh_boat matches 0.. if score @s bacaptmh_boatm matches 0.. run scoreboard players operation #b7d bacaptmh_tmp = @s bacaptmh_boat
execute if score #b7mode bacaptmh_tmp matches 1 if score @s bacaptmh_boat matches 0.. if score @s bacaptmh_boatm matches 0.. run scoreboard players operation #b7d bacaptmh_tmp -= @s bacaptmh_boatm
execute if score #b7mode bacaptmh_tmp matches 1 if score @s bacaptmh_boat matches 0.. run scoreboard players operation @s bacaptmh_boatm = @s bacaptmh_boat
...
execute if score #b7mode bacaptmh_tmp matches 2 run scoreboard players set #b7d bacaptmh_tmp 0
execute if score #b7mode bacaptmh_tmp matches 2 if score @s bacaptmh_hg matches 0.. if score @s bacaptmh_hgm matches 0.. run scoreboard players operation #b7d bacaptmh_tmp = @s bacaptmh_hg
execute if score #b7mode bacaptmh_tmp matches 2 if score @s bacaptmh_hg matches 0.. if score @s bacaptmh_hgm matches 0.. run scoreboard players operation #b7d bacaptmh_tmp -= @s bacaptmh_hgm
execute if score #b7mode bacaptmh_tmp matches 2 if score @s bacaptmh_hg matches 0.. run scoreboard players operation @s bacaptmh_hgm = @s bacaptmh_hg
