...
execute if entity @a[advancements={bacaptmh:challenges/fashion_police=false},limit=1] as @a[gamemode=!spectator,scores={bacaptmh_dress_t=1..}] at @s run function bacaptmh:detect/fashion_police_check
