...
execute if score #players bacaptmh_sys matches 3.. if entity @a[advancements={bacaptmh:biomes/sculk_silence=false},limit=1] run function bacaptmh:detect/sculk_silence
...
execute if entity @a[advancements={bacaptmh:challenges/fashion_police=false},limit=1] run scoreboard players set #need bacaptmh_n 1
