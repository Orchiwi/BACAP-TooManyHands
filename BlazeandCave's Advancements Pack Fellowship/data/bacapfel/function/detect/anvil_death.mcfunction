...
scoreboard players set #anvok bacapfel_sys 0
execute if entity @s[advancements={bacapfel:weaponry/falling_out={crushed_anvil=true}}] run scoreboard players set #anvok bacapfel_sys 1
execute if entity @s[advancements={bacapfel:weaponry/falling_out={crushed_chipped=true}}] run scoreboard players set #anvok bacapfel_sys 1
execute if entity @s[advancements={bacapfel:weaponry/falling_out={crushed_damaged=true}}] run scoreboard players set #anvok bacapfel_sys 1
execute if score #anvok bacapfel_sys matches 1 run function bacapfel:detect/anvil_pay
