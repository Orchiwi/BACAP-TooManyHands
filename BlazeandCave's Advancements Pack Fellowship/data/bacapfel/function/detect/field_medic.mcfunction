...
advancement revoke @s only bacapfel:potion/field_medic dosed
...
scoreboard players set #hp bacapfel_tmp4 0
execute store result score #hp bacapfel_tmp4 run data get entity @s Health 10
execute if score #hp bacapfel_tmp4 matches 1..59 run function bacapfel:detect/field_medic_grant
