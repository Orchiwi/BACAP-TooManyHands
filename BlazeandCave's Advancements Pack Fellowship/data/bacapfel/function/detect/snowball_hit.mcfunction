...
tag @s add bacapfel_sb_owner
execute as @a[tag=!bacapfel_sb_owner,distance=..1.6,gamemode=!spectator] run function bacapfel:detect/snowball_victim
tag @s remove bacapfel_sb_owner
