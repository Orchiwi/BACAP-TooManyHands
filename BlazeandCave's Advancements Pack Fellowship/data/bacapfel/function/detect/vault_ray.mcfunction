...
execute if block ~ ~ ~ minecraft:vault[ominous=true] run function bacapfel:detect/vault_read
execute if block ~ ~ ~ minecraft:vault[ominous=true] run return 0
scoreboard players add #ray bacapfel_n 1
execute if score #ray bacapfel_n matches ..11 positioned ^ ^ ^0.4 run function bacapfel:detect/vault_ray
